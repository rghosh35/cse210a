...
Lemma map_ref_auxiliary : forall (X Y : Type) (f : X -> Y) (l1 l2 : list X),
...
Proof.
  ...
  - simpl. rewrite <- IHl. rewrite map_ref_auxiliary. reflexivity.
...
intros. induction p. reflexivity. Qed.
(** [] *)
...
(* 
  ...
  Theorem: For any [X], [l] and [n],
    ...
    Proof: By induction on [n].
        ...
        - When n = 0, then [length l = 0],



            So, nth_error X [ ] 0 = None    is direclty followed.
        ...
        - When [n = k] and [l = l' ++ [a]]. 
            ...
            length l' = k => nth_error X l' k = None becomes true
            ...
            length l = (k+1) => nth_error X l (k+1) = None

          

            So, for [nth_error X (l' ++ [a]) (k+1)], there will be two cases,

            

              Case 1: [nth_error X l' k = None] is from the hypothesis.



              Case 2: [nth_error X [a] 1 = None] is the definition of nth_error.



          Hence, [nth_error X l n = None] becomes true for k+1.
